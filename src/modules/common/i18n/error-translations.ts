export const error_translations = {
  es: {
    ...
    'errors.field_value_already_exists': 'Este valor ya esta en uso.',
    ...
    'common.outbox_event_payload_invalid':
      'El payload del evento de outbox no es valido.',
  ...
  en: {
    ...
    'errors.field_value_already_exists': 'This value is already in use.',
    ...
    'common.outbox_event_payload_invalid':
      'The outbox event payload is not valid.',
    'sales.order_reservations_already_exist':
