export const error_translations = {
  es: {
    ...
    'errors.unique_constraint_violation': 'Ya existe un registro con ese valor. Verifica que no este duplicado.',
  ...
  en: {
    ...
    'errors.unique_constraint_violation': 'A record with that value already exists. Check for duplicates.',
