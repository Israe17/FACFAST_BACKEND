...
export class ContactSerializer implements EntitySerializer<Contact, ContactView> {
  ...
  serialize(
    ...
    return {
      ...
      province: contact.province_ref?.name ?? contact.province,
      canton: contact.canton_ref?.name ?? contact.canton,
      district: contact.district_ref?.name ?? contact.district,
      country_id: contact.country_id ?? null,
      province_id: contact.province_id ?? null,
      canton_id: contact.canton_id ?? null,
