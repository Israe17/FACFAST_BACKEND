...
export class BranchSerializer implements EntitySerializer<Branch, BranchView> {
  ...
  serialize(
    ...
    return {
      ...
      province: branch.province_ref?.name ?? branch.province,
      canton: branch.canton_ref?.name ?? branch.canton,
      district: branch.district_ref?.name ?? branch.district,
      city: branch.city,
      country_id: branch.country_id ?? null,
      province_id: branch.province_id ?? null,
      canton_id: branch.canton_id ?? null,
      district_id: branch.district_id ?? null,
      phone: branch.phone,
      email: branch.email,
